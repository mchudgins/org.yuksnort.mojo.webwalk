...
import org.yuksnort.web.util.validator.NuHtmlValidator;
...
public class NuHtmlValidatorTester
	{
	private static final Logger	log		= Logger.getLogger( NuHtmlValidatorTester.class );
	private	static final String	simplestHtml	= "<!doctype html><html><head><title>title</title></head><body></body></html>";
	private static final String	simpleBadHtml	= "<!fubar><html><body></body></html>";
	private	static final String	twoLineBadHtml	= "<!doctype html><html><head>\n</head><body></body></html>";

	private Validator		validator			= new NuHtmlValidator();
	
	@Test
	public void testJetty() throws InterruptedException
		{
	...
	@Test
	public void	testTwoLineBadHtml()
		{
		this.validator.validate( twoLineBadHtml );
